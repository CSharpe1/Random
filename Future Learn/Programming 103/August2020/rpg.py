...
try:
    ...
    with open("Future Learn\Programming 103\August2020\\gamedata.json", "r") as f:
    ...
    f = open('Future Learn\Programming 103\August2020\\gamedata.json', 'w')
    f.close()
    name = None
    health = 5
    currentRoom = 'Hall'
...
with open("Future Learn\Programming 103\August2020\\gamedata.json", "w") as f:
